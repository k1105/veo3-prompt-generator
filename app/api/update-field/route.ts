...
export async function POST(request: NextRequest) {
  try {
    ...
    const fieldPrompts: {[key: string]: string} = {
      title: "映像シーンのタイトル",
      concept: "映像シーンのコンセプト・テーマ",
      summary: "映像シーンの概要・ストーリー",
      "visualStyle.style": "映像の視覚スタイル",
      ...
      "audioDesign.dialogue": "対話・セリフ",
      "audioDesign.voiceover": "ナレーション",
      "setting.location": "場所・ロケーション",
      "setting.timeOfDay": "時間帯",
      "setting.weather": "天気",
      "setting.backgroundElements": "背景要素",
